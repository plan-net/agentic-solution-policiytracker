---
title: GDPR Compliance Failures Lead to Surge in Fines - Sentra
url: https://www.sentra.io/blog/gdpr-compliance-failures-lead-to-surge-in-fines
published_date: 2025-11-06T12:26:09.885000
collected_date: 2025-11-11T12:26:10.612953
source: Sentra
source_url: https://www.sentra.io
author: Meni BessoDirector of Product Management
description: [Sentra Expands Data Security Platform with On-Prem Scanners for Hybrid Environments](https://www.sentra.io/news/sentra-expands-data-security-platform-with-on-premises-scanners-for-hybrid-and-private-environments)
language: en
collection_type: policy_landscape
---

# GDPR Compliance Failures Lead to Surge in Fines - Sentra

*By Meni BessoDirector of Product Management*

[Sentra Expands Data Security Platform with On-Prem Scanners for Hybrid Environments](https://www.sentra.io/news/sentra-expands-data-security-platform-with-on-premises-scanners-for-hybrid-and-private-environments)

[Sentra Expands Data Security Platform with On-Prem Scanners for Hybrid Environments](https://www.sentra.io/news/sentra-expands-data-security-platform-with-on-premises-scanners-for-hybrid-and-private-environments)

[All Resources](https://www.sentra.io/blog)

[This is some text inside of a div block.](https://www.sentra.io/www.sentra.io)

# GDPR Compliance Failures Lead to Surge in Fines

[Meni Besso\
\
Director of Product Management](https://www.sentra.io/our-data-security-experts/meni-besso)
...
The latest high-profile case involves TikTok, which was recently fined a staggering €530 million ($600 million) by the Irish Data Protection Commission ( [DPC](https://www.dataprotection.ie/en)) for violations related to the General Data Protection Regulation ( [GDPR](https://www.sentra.io/cloud-data-security-glossary/gdpr)). This is a wake up call for multinational companies.
...
Over the past few years, large language models ( [LLMs](https://www.sentra.io/cloud-data-security-glossary/large-language-models-llms)) have dominated the AI conversation. From writing essays to generating code, LLMs like GPT-4 and Claude have proven that massive models can produce human-like language and reasoning at scale.
...
At sixteen, my mother signed me up to speak at a community event, without telling me first! I stood before 500 people and spoke about something that had long bothered me: there were no women on our community board. That same year, two women were appointed for the first time in our community’s history. This year, I was given the recognition for being a Community Leader at the [Global Gujrati Gaurav Awards](https://www.youtube.com/watch?v=90GEhsdLNwA) in BC for my work in educating seniors on cyber safety and helping many immigrants secure jobs.
...
Through **Standout to Lead**, I partnered with [_Women Get On Board_](https://womengetonboard.ca/) to help women in cybersecurity gain board seats. Watching more women step into decision-making roles reminds me that leadership isn’t about titles, it’s about creating pathways for others.

### **Women in Cybersecurity: Our Collective Story**

This year, I’m deeply honored to be named among the **Top 20 Cybersecurity Women of the World** by the [United Cybersecurity Alliance](https://www.unitedcybersecurityalliance.org/). Their mission - to empower women, elevate diverse voices, and drive equity in our field, mirrors everything I believe in.
...
Join me and the Sentra team at _The WOMEN IN SECURITY Documentary_ Premiere, a celebration of leadership, resilience, and the voices shaping the future of our industry.

Save your [seat at _The Women in Security_ premiere here](https://docs.google.com/forms/d/e/1FAIpQLScTgEQZVcu-PtyuFmX8cqc33Yrf11Amh8fSL8tUYBrUF1Xsow/viewform) (spots are limited).

Follow Sentra on [LinkedIn](https://www.linkedin.com/company/sentraio/) and [YouTube](https://www.youtube.com/@SentraInc) for more updates on the event and stories that inspire change.
...
As [Bitsight notes](https://www.bitsight.com/blog/how-spend-remaining-budget-wisely-you-lose-it?utm_source=chatgpt.com), many organizations look for smart ways to use remaining funds that don’t roll over. The goal isn’t simply to spend, it’s to invest in initiatives that improve posture and provide measurable, lasting value. And according to [Applied Tech](https://www.appliedtech.us/resource-hub/10-ways-to-spend-your-year-end-it-budget/?utm_source=chatgpt.com), “using remaining IT funds strategically can strengthen your position for the next budget cycle.”
...
(For additional background, see [Sentra’s article on why DSPM should take a slice of your cybersecurity budget](https://www.sentra.io/blog/why-dspm-should-take-a-slice-of-your-2024-cyber-security-budget).)
...
- **Hands-on training** platforms like _Hack The Box_, _INE Skill Dive_, or _Security Blue Team_, which develop real-world skills through simulated environments.
...
That feedback reflects a growing consensus: without visibility into where sensitive data resides, who can access it, and how it’s secured, every other layer of defense operates partly in the dark.\* **Tip**: If your remaining 2025 budget won’t suffice for a full DSPM deployment, you can scope an initial implementation with the remaining budget, then expand to full coverage in 2026.
...
[DSPM](https://www.sentra.io/data-security-posture-management) fits that description perfectly.
...
[Sign up for a demo](https://www.sentra.io/demo) and learn how Sentra’s data security platform can uncover hidden risks, simplify compliance, and safeguard your sensitive data.

Follow us on [LinkedIn](https://www.linkedin.com/company/sentra-io/), [X (Twitter)](https://twitter.com/sentra_security), and [YouTube](https://www.youtube.com/@sentra_security/videos) for actionable expert insights on how to strengthen your data security, build a successful DSPM program, and more!
