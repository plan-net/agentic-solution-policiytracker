...
- Commission to establish a digital one-stop-shop with free access to templates, guidelines and information for companies

- No civil liability at the EU level but victims to receive full compensation from companies breaching due diligence obligations
...
With 17 votes for, 6 against and 2 abstentions, the [Legal Affairs Committee](https://www.europarl.europa.eu/committees/en/juri/home/highlights) approved its position on a series of changes to sustainability reporting and due diligence requirements for companies.

**Reduced social and environmental reporting**

The Commission originally proposed cutting the number of companies required to carry out [social and environmental reporting](https://www.europarl.europa.eu/news/en/press-room/20221107IPR49611/sustainable-economy-parliament-adopts-new-reporting-rules-for-multinationals) by 80%, whereas MEPs want to reduce the scope further to cover only those companies with over 1,000 employees on average and a net annual turnover above 450 million euro. This would also apply to sustainability reporting under [taxonomy rules](https://finance.ec.europa.eu/publications/commission-cut-eu-taxonomy-red-tape-companies_en) (i.e. a classification of sustainable investments).
...
The Commission would also establish a digital portal for companies with free access to templates, guidelines and information on all EU reporting requirements complementing the [European Single Access Point](https://www.european-financial-data-space.com/European_Single_Access_Point_(ESAP).html).

**Due diligence only for big companies and no EU liability**

According to MEPs, [due diligence](https://single-market-economy.ec.europa.eu/sectors/raw-materials/due-diligence-ready/due-diligence-explained_en) rules requiring companies to prevent and limit their adverse impact on human rights and the environment should only apply to large EU businesses with more than 5,000 employees and a net yearly turnover above 1.5 billion euro, and to foreign businesses with a net turnover in the EU above the same threshold.

Instead of systematically asking for information required for their due diligence assessments from their business partners, MEPs want these companies to adopt a risk-based approach, whereby they only ask for the necessary information where there is a prospect of an adverse impact in their business partners’ activities. In the case of firms outside the scope of the rules, this would be possible only as a last resort. Companies would still be required to prepare a transition plan aligning their strategy to a sustainable economy and the [Paris Agreement](https://unfccc.int/process-and-meetings/the-paris-agreement).

Businesses should be liable for damages caused by breaches of due diligence obligations under national law, rather than at the EU level. The maximum fine level for offending companies would be at 5% of their global turnover, and the Commission and EU member states should provide guidance for national authorities on these penalties.

Rapporteur [Jörgen Warborn (EPP, SE)](https://www.europarl.europa.eu/meps/en/197405/JORGEN_WARBORN/home) said: “Today’s vote confirms our support for simplification. We are delivering predictability for European companies, with a report that cuts costs, strengthens competitiveness, and keeps Europe’s green transition on track.”
...
The Commission presented its [Omnibus I](https://commission.europa.eu/publications/omnibus-i_en) simplification package on 26 February. Besides rules simplifying due diligence requirements and sustainability reporting, it also contained file delaying application of these rules for some companies, which was approved by the European Parliament via [urgent procedure](https://www.europarl.europa.eu/doceo/document/RULES-10-2025-01-20-RULE-170_EN.html) in April 2025.
...
- [Press conference with the rapporteur (13 October 2025)](https://multimedia.europarl.europa.eu/en/webstreaming/press-conference-by-jorgen-warborn-epp-se-rapporteur-on-simplified-sustainability-reporting-and-due_20251013-1815-SPECIAL-PRESSER)

- [Voting list and compromise amendments (point 9)](https://emeeting.europarl.europa.eu/emeeting/committee/en/agenda/202510/JURI?meeting=JURI-2025-1013_1&session=10-13-16-00)

- [Procedure file](https://oeil.secure.europarl.europa.eu/oeil/en/procedure-file?reference=2025/0045(COD))
