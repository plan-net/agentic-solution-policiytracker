...
from src.chat.agent.production_config import ProductionConfig, DeploymentMode
    ...
    def simple_orchestrator(self, production_config):
        ...
        mock_tools = {
            "search": AsyncMock(return_value={
                ...
                "edges": [{"source": "EU", "target": "Test Policy", "relationship": "PROPOSES"}],
...
Organizations operating digital services in the EU must assess their obligations under the DSA and implement appropriate compliance measures."""
        ...
        print(f"✅ Quality assessment integration test passed!")
    ...
    def test_production_config_integration(self, production_config):
        ...
        print(f"✅ Production config integration test passed!")
    ...
    async def test_system_component_integration(self):
        ...
        print(f"✅ System component integration test passed!")
        print(f"Components initialized: Memory, Streaming, Quality, Agents")
