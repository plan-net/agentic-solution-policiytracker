...
from src.workflow.nodes import (
    load_documents, load_context, process_documents, 
    score_documents, cluster_results, generate_report
)
...
""")
    ...
    async def test_load_context_node_isolation_azure(self, mock_azure_client_class, basic_state, mock_azure_settings, sample_azure_context_file):
    ...
    async def test_process_documents_node_isolation_local(self, mock_processor_class, basic_state, local_settings):
    ...
    @pytest.mark.asyncio
    @patch('src.workflow.nodes.ContentProcessor')
    async def test_process_documents_node_isolation_azure(self, mock_processor_class, basic_state, mock_azure_settings):
    ...
    async def test_cluster_results_node_isolation(self, mock_aggregator_class, mock_clusterer_class, basic_state):
    ...
    async def test_generate_report_node_isolation_local(self, mock_makedirs, mock_generator_class, basic_state, local_settings):
    ...
    @patch('src.workflow.nodes.AzureStorageClient')
    @patch('src.workflow.nodes.ReportGenerator')
    async def test_generate_report_node_isolation_azure(self, mock_generator_class, mock_azure_client_class, basic_state, mock_azure_settings):
