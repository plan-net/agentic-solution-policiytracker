...
class TestDataIngestionApp:
    ...
    async def test_ingest_documents_nonexistent_source_path(self):
        ...
        mock_request = MagicMock()
        inputs = {"job_name": "Test Job", "document_limit": 10}
    ...
    async def test_ingest_documents_valid_input(self, temp_directory):
        ...
        mock_request = MagicMock()
        inputs = {"job_name": "Valid Test Job", "document_limit": 5, "clear_data": True}
        ...
        with patch("src.flows.data_ingestion.app.Path") as mock_path, patch(
            "src.flows.data_ingestion.app.Launch"
        ) as mock_launch:
...
class TestErrorHandling:
    ...
    async def test_type_conversion_errors(self):
        ...
        for invalid_limit in invalid_limits:
            inputs = {"job_name": "Test Job", "document_limit": invalid_limit}
