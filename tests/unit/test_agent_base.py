...
from src.chat.agent.state import QueryAnalysis, ToolPlan, ToolResult
...
class TestMultiAgentState:
    ...
    def test_multi_agent_state_initialization(self):
        ...
        assert state.get("current_agent", "query_understanding") == "query_understanding"  # Use default in get()
...
class TestBaseAgent:
    ...
    def test_create_success_result(self):
        ...
        result = agent.create_success_result(
            data={"key": "value"},
            metadata={"meta": "data"}
        )
    ...
    def test_create_error_result(self):
        ...
        result = agent.create_error_result(
