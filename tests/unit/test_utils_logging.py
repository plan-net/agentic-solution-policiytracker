...
from src.utils.logging import log_performance, setup_logging
...
class TestSetupLogging:
    ...
    def test_setup_logging_json_format(
        self, mock_structlog_configure, mock_logging_config, mock_settings
    ):
    ...
    def test_setup_logging_different_log_levels(
        ...
        for level in test_levels:
            ...
            mock_logging_config.assert_called_once_with(
                format="%(message)s", stream=sys.stdout, level=expected_level
            )
    ...
    def test_setup_logging_returns_logger(
        self, mock_get_logger, mock_structlog_configure, mock_logging_config, mock_settings
    ):
...
class TestLogPerformance:
    ...
    def test_log_performance_different_operations(self, mock_get_logger, mock_settings):
        ...
        for operation, duration in operations:
            ...
            mock_logger.info.assert_called_once_with(
                "Performance metric", operation=operation, duration_ms=duration
            )
...
class TestLoggingEdgeCases:
    ...
    def test_empty_operation_name(self, mock_settings):
        ...
        with patch("structlog.get_logger") as mock_get_logger:
            ...
            mock_logger.info.assert_called_once_with(
                "Performance metric", operation="", duration_ms=100.0
            )
    ...
    def test_negative_duration(self, mock_settings):
        ...
        with patch("structlog.get_logger") as mock_get_logger:
            ...
            mock_logger.info.assert_called_once_with(
                "Performance metric", operation="test_op", duration_ms=-50.0
            )
    ...
    def test_zero_duration(self, mock_settings):
        ...
        with patch("structlog.get_logger") as mock_get_logger:
            ...
            mock_logger.info.assert_called_once_with(
                "Performance metric", operation="instant_op", duration_ms=0.0
            )
