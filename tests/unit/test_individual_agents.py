...
from src.chat.agent.agents import (
    ...
    QueryAnalysis, ToolPlan, ToolResult, ResponseSynthesis
)
...
class TestQueryUnderstandingAgent:
    ...
    @pytest.mark.asyncio
    async def test_query_analysis_with_memory_integration(self, query_agent, sample_multi_agent_states):
...
class TestToolPlanningAgent:
    ...
    @pytest.mark.asyncio
    async def test_planning_with_memory_integration(self, planning_agent, sample_multi_agent_states):
...
class TestToolExecutionAgent:
    ...
    async def test_successful_tool_execution(self, execution_agent, sample_multi_agent_states):
        ...
        with patch.object(execution_agent, 'stream_thinking') as mock_stream, \
             patch.object(execution_agent, 'stream_custom') as mock_tool_stream:
...
class TestResponseSynthesisAgent:
    ...
    @pytest.mark.asyncio
    async def test_synthesis_with_memory_integration(self, synthesis_agent, sample_multi_agent_states):
...
class TestAgentIntegration:
    ...
    async def test_agent_state_progression(self, sample_multi_agent_states, sample_queries):
        ...
        with patch.object(execution_agent, 'stream_thinking'), \
             patch.object(execution_agent, 'stream_custom'):
