"""
Test Anthropic LLM Provider for Graphiti Entity Extraction (Standalone)

This is a focused test that runs ONLY Anthropic to isolate any issues.
"""
...
async def test_anthropic_only():
    ...
    print("\n" + "=" * 80)
    print("Anthropic-Only Test for Graphiti Entity Extraction")
    print("=" * 80 + "\n")
    ...
    group_id = "test_anthropic_isolated"
    os.environ["GRAPHITI_LLM_PROVIDER"] = "anthropic"
    os.environ["GRAPHITI_GROUP_ID"] = group_id

    print(f"🔧 Configuration:")
    print(f"  Provider: anthropic")
    print(f"  Model: {os.getenv('GRAPHITI_ANTHROPIC_MODEL', 'claude-sonnet-4-5-latest')}")
    print(f"  Group ID: {group_id}\n")

    # Process documents
    print("🚀 Processing documents with Anthropic...\n")
...
if __name__ == "__main__":
    asyncio.run(test_anthropic_only())
