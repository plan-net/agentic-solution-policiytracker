"""
Test GPT-4.1-nano for Graphiti Entity Extraction (Standalone)

This is a focused test that runs ONLY gpt-4.1-nano to compare with gpt-4o-mini.
"""
...
async def test_gpt41_nano():
    """Test GPT-4.1-nano provider in isolation."""
    print("\n" + "=" * 80)
    print("GPT-4.1-nano Test for Graphiti Entity Extraction")
    print("=" * 80 + "\n")
    ...
    # Set environment for OpenAI with gpt-4.1-nano
    group_id = "test_gpt41_nano"
    os.environ["GRAPHITI_LLM_PROVIDER"] = "openai"
    os.environ["OPENAI_MODEL"] = "gpt-4.1-nano"  # Used by create_graphiti_llm_client
    ...
    # Process documents
    print("🚀 Processing documents with GPT-4.1-nano...\n")
