                ...
                "tool_sequence": [
                    ...
                    },
                    {
                        ...
                        "parameters": {
                            ...
                            "relationship_types": ["AUTHORED_BY", "ENFORCES"],
                        },
                    ...
                    },
                    {
                        ...
                        "tool_name": "search",
                        "parameters": {
                            "query": "EU AI Act implementation requirements",
                            "limit": 10,
                        },
        ...
        return {
            "experienced_user": {
                ...
                "conversation_history": [
                    ...
                    AIMessage(
                        content="Recent GDPR enforcement includes several significant fines..."
                    ),
                    HumanMessage(
                        content="How does this affect social media companies specifically?"
                    ),
                    AIMessage(
                        content="Social media companies face particular challenges under GDPR..."
                    ),
                ],
                "learned_patterns": {
                    "query_patterns": [
