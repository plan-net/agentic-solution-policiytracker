...
class MockMemoryManager:
    ...
    async def get_conversation_context(self, thread_id: str, max_tokens: int = None) -> List[BaseMessage]:
        """Mock conversation context retrieval."""
        self._log_call("get_conversation_context", {"thread_id": thread_id, "max_tokens": max_tokens})
    ...
    async def update_tool_performance(self, tool_name: str, success: bool, execution_time: float, error: Optional[str] = None) -> None:
        """Mock tool performance update."""
        self._log_call("update_tool_performance", {
            "tool_name": tool_name,
            "success": success,
    ...
    async def learn_from_query(self, user_id: str, query: str, intent: str, entities: List[str], satisfaction_rating: Optional[float] = None) -> None:
        """Mock query learning."""
        self._log_call("learn_from_query", {
            "user_id": user_id,
            "intent": intent,
    ...
    def add_test_user_data(self, user_id: str, preferences: Dict[str, Any] = None, insights: Dict[str, Any] = None) -> None:
        """Add test user data."""
        if preferences:
...
class MockStreamingManager:
    ...
    async def emit_thinking(self, agent_name: str, thought: str, metadata: Dict[str, Any] = None) -> None:
    ...
    async def emit_progress(self, agent_name: str, progress: str, percentage: Optional[float] = None) -> None:
    ...
    async def emit_tool_execution(self, agent_name: str, tool_name: str, status: str, result_preview: str = "") -> None:
    ...
    async def emit_error(self, agent_name: str, error_message: str, error_type: str = "error") -> None:
        """Mock error emission."""
        event = {
            "type": "error",
            "agent": agent_name,
