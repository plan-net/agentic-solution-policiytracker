...
class MockKnowledgeGraphTools:
    ...
    async def search(self, query: str, limit: int = 10) -> Dict[str, Any]:
        ...
        for entity_name, entity_data in self.mock_data["entities"].items():
            if any(term in entity_name.lower() or term in entity_data["description"].lower() 
    ...
    async def entity_lookup(self, entity_name: str) -> Dict[str, Any]:
        ...
        if entity_name in self.mock_data["entities"]:
            ...
            entity_data["fact_count"] = len([f for f in self.mock_data["facts"] 
    ...
    async def traverse_from_entity(self, entity_name: str, direction: str = "both", max_hops: int = 2) -> Dict[str, Any]:
        """Mock multi-hop relationship traversal."""
        self._log_call("traverse_from_entity", {
    ...
    async def find_paths_between_entities(self, entity1: str, entity2: str, max_path_length: int = 3) -> Dict[str, Any]:
        """Mock path discovery between entities."""
        self._log_call("find_paths_between_entities", {
            "entity1": entity1,
            "entity2": entity2, 
        ...
        return {
            ...
            "shortest_path_length": min([p["length"] for p in paths_found]) if paths_found else None,
    ...
    async def get_entity_neighbors(self, entity_name: str, relationship_types: Optional[List[str]] = None) -> Dict[str, Any]:
        """Mock immediate entity connections."""
        self._log_call("get_entity_neighbors", {
            "entity_name": entity_name,
    ...
    async def search_by_date_range(self, start_date: str, end_date: str, entity_filter: Optional[str] = None) -> Dict[str, Any]:
        """Mock time-scoped search."""
        self._log_call("search_by_date_range", {
        ...
        if entity_type:
            ...
            for community in communities:
                ...
                for member in community["members"]:
                    if member in self.mock_data["entities"] and \
                       self.mock_data["entities"][member]["type"] == entity_type:
    ...
    def add_mock_relationship(self, source: str, target: str, rel_type: str, context: str = "") -> None:
    ...
    def add_mock_fact(self, content: str, entities: List[str], source: str = "test", date: str = None) -> None:
