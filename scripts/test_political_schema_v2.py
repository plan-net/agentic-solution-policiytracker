...
def test_eu_ai_act_lobbying():
    ...
    print(
        f"✅ Created lobbying relationship: {tech_lobbying.success_probability} success probability"
    )
...
def main():
    ...
    try:
        ...
        print(
            f"🔗 Schema defines {SCHEMA_STATISTICS['total_relationship_types']} relationship types"
        )
