...
MCP_CLIENT_TIMEOUT = float(os.getenv("MCP_CLIENT_TIMEOUT", "180.0"))  # 3 minutes for connection
MCP_STREAM_TIMEOUT = float(os.getenv("MCP_STREAM_TIMEOUT", "300.0"))  # 5 minutes for tool execution
