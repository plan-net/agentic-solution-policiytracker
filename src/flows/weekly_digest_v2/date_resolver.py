"""
Date Resolution for Weekly Digest v2.
...
Adapted from src/flows/weekly_report/date_resolver.py for the v2 implementation.
"""
...
class DateResolver:
    ...
    def _week_to_dates(self, week_number: int, year: int) -> dict:
        ...
        if not 1 <= week_number <= 53:
            raise DateResolutionError(
                f"Invalid week number: {week_number} (must be 1-53)"
            )
