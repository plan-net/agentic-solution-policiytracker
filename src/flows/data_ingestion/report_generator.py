...
class IngestionReportGenerator:
    ...
    def _create_executive_summary(self, processing_results: List[Dict], 
                                 communities: List[Dict], config: Dict) -> Dict:
    ...
    async def generate_report(self, processing_results: List[Dict], 
                            communities: List[Dict], config: Dict,
                            job_name: str = "Document Ingestion") -> str:
        """Generate comprehensive ingestion report."""
        
        try:
            # Prepare all template data
            executive_summary = self._create_executive_summary(processing_results, communities, config)
            ...
            template_context = {
                ...
                "config_used": {
                    ...
                    "entity_types": [
                        "Policy", "Company", "Politician", "GovernmentAgency",
                        "LegalFramework", "Regulation", "LobbyGroup"
                    ]
                },
            ...
            logger.info("Generated ingestion report",
