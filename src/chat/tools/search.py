...
class SearchInput(BaseModel):
    ...
    search_type: str = Field(default="comprehensive", description="Type of search: 'comprehensive', 'relationship_focused', 'entity_focused', or 'episode_focused'")
...
class GraphitiSearchTool(BaseTool):
    ...
    async def _arun(
        ...
        try:
            ...
            logger.info(f"Returning {len(formatted_results)} formatted results with {len(sources)} sources")
            return response
