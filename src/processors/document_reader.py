...
from src.utils.validators import validate_file_size, validate_file_extension, get_supported_extensions
...
class DocumentReader:
    ...
    async def read_document(self, file_path: str, use_azure: bool = False) -> Tuple[str, DocumentMetadata]:
    ...
    async def _read_document_azure(self, blob_name: str) -> Tuple[str, DocumentMetadata]:
        ...
        metadata = self._extract_azure_metadata(blob_name, doc_type, blob_properties, len(blob_data))
    ...
    def _extract_azure_metadata(self, blob_name: str, doc_type: DocumentType, blob_properties: Optional[Dict], file_size: int) -> DocumentMetadata:
