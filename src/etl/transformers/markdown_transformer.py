...
class MarkdownTransformer:
    ...
    def _generate_body(self, article: Dict[str, Any]) -> str:
        ...
        if content and content.strip():
            ...
            parts.append("**Note:** Full article content not available. This appears to be a headline/summary from RSS feeds.")
            parts.append("")
            parts.append(f"📰 **Read full article:** [{article.get('url', '')}]({article.get('url', '')})")
