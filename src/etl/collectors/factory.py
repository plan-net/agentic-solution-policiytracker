...
def create_news_collector(collector_type: str = None) -> Union[ApifyNewsCollector, ExaNewsCollector, ExaDirectCollector]:
    """
    ...
    if collector_type == "apify":
        ...
        raise ValueError(f"Unsupported collector type: {collector_type}. Supported types: 'apify', 'exa', 'exa_direct'")
