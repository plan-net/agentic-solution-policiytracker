...
ENHANCED_POLITICAL_ENTITIES = {
    ...
    "ConsultationProcess": {
        ...
        "examples": [
            "EU AI Act Public Consultation",
            "FCC Net Neutrality Comments",
            "Basel III Industry Feedback",
        ],
    },
    ...
    "ImplementationPhase": {
        ...
        "examples": [
            "GDPR Phase 1: Data Mapping",
            "Basel III Phase-in Period",
            "AI Act Grace Period",
        ],
    },
...
class PolicyEntity(PoliticalEntity):
    ...
    date_introduced: Optional[datetime] = Field(
        None, description="When policy was first introduced"
    )
...
class CompanyEntity(PoliticalEntity):
    ...
    size: Optional[str] = Field(
        None, description="Company size (small, medium, large, multinational)"
    )
    ...
    jurisdictions_active: list[str] = Field(
        default_factory=list, description="Jurisdictions where company operates"
    )
...
class BusinessImpactRelationship(PoliticalRelationship):
    ...
    impact_severity: Optional[ImpactSeverity] = Field(
        None, description="Severity of business impact"
    )
...
class InfluenceRelationship(PoliticalRelationship):
    ...
    success_probability: Optional[float] = Field(
        None, ge=0.0, le=1.0, description="Likelihood of success"
    )
...
class ExtractionResult(BaseModel):
    ...
    relationships: list[PoliticalRelationship] = Field(
